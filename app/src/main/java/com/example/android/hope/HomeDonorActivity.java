...
public class HomeDonorActivity extends AppCompatActivity {
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    ...
                    if(task.isSuccessful()){
                        ...
                        if(!task.getResult().exists()){
                            ...
                            Intent setupIntent = new Intent(HomeDonorActivity.this, setup.class);
                        ...
                        Toast.makeText(HomeDonorActivity.this,"Error: " + errorMessage, Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch ((item.getItemId())){
            ...
            case R.id.action_settings_btn:
                ...
                Intent settingsIntent = new Intent(HomeDonorActivity.this, SetupNormal.class);
    ...
    private void sendToLogin() {
        ...
        Intent loginIntent = new Intent(HomeDonorActivity.this, Login.class);
